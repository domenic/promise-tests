...
describe("Multiple handlers", function () {
    describe("when there are multiple fulfillment handlers for a fulfilled promise", function () {
        ...
        describe("and each fulfillment handler returns a different value", function () {
            it("should forward each value to the next corresponding fulfillment handler", function (done) {
